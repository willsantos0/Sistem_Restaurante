...
SearchComponent = __decorate([
    core_1.Component({
        ...
        template: "\n         <div class=\"form-inline\"> \n            <div class=\"form-group\">\n                <label><h3>Pesquisar: </h3></label>\n            </div>\n          <div class=\"form-group\">\n            <div class=\"col-lg-12\">\n              <input class=\"form-control\" placeholder=\"Entre com a busca..\" (paste)=\"getPasteData($event)\" (keyup)=\"getEachChar($event.target.value)\" type=\"text\" [(ngModel)]=\"listFilter\" /><img src=\"../../images/cross.png\" class=\"cross-btn\" (click)=\"clearFilter()\" *ngIf=\"listFilter\"/>\n            </div>\n          </div>\n        </div>\n     "
    })
], SearchComponent);
